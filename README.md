...
cp -r meditate ~/.hermes/skills/meditate/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/meditate-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/meditate-skill.git ~/.hermes/skills/meditate/
```
...
```text
Use the meditate skill to <describe your specific task here>
```
...
```text
Gunakan skill meditate untuk <deskripsikan tugas spesifik Anda di sini>
```
